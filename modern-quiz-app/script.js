...
class QuizApp {
                ...
                hard: [
                    {
                        ...
                        options: ["Creeper", "Brain", "Elk Cloner", "Morris"],
                        correct: 0
                    },
                    {
                        question: "In which year was the first Bitcoin transaction?",
    ...
    displayResults() {
        ...
        document.getElementById('score-text').textContent = this.score + '/' + this.questions.length;
    ...
    updatePerformanceMessage(percentage) {
        ...
        if (percentage >= 90) {
            ...
            descriptionElement.textContent = 'Outstanding performance! You really know your stuff!';
        } else if (percentage >= 70) {
            titleElement.textContent = 'Great job!';
            descriptionElement.textContent = 'Well done! You have a solid understanding of the topic.';
